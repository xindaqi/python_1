...
def getLayeredCell(layer_size, num_units, input_keep_prob,
	...
	#return rnn.MultiRNNCell([rnn.DropoutWrapper(tf.nn.rnn_cell.LSTMCell(name="basic_lstm_cell", num_units), input_keep_prob, output_keep_prob) for i in range(layer_size)])
