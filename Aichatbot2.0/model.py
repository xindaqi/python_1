        ...
        with self.train_graph.as_default():
            ...
            for step in range(start, epochs):
                ...
                if step % self.save_step == 0:
                    ...
                    print('******************************')
                    print('src:{}'.format(input_text.encode('utf-8')))
                    print('output:{}'.format(output_text.encode('utf8')))
                    print('target:{}'.format(target_text.encode('utf8')))
                ...
                for i in range(len(outputs)):
                    ...
                    if random.randint(1, prob) == 1:
                        ...
                        input_text = reader.decode_text(in_seq[i],
                                self.eval_reader.vocabs)
                        print('src:{}'.format(input_text.encode('utf8')))
                        print('output:{}'.format( ' '.join(output_text).encode('utf8')))
                        print('target:{}'.format(' '.join(target_text).encode('utf8')))
